...
import com.campass.demo.service.SSCampingService;

import lombok.RequiredArgsConstructor;

@Controller
@RequestMapping
public class SellerCampingController {

    @Autowired(required = true)
    private SSCampingService campingService;
    ...
    public String List(@RequestParam(defaultValue = "1") Integer pageno, Model model, Principal principal) {
        ...
        return "seller/camping/campingAll";
    }

    // 캠핑추가
    @GetMapping("/seller/cAdd")
    public String campingAddView() {
        return "seller/camping/write";
    }
